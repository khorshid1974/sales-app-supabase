        ...
        <nav class="nav">
            <ul class="flex flex-row justify-between">
                ...
                <span class="flex space-x-2 items-center">
                    ...
                    <li><nuxt-link to="/Items/new">New Item</nuxt-link></li>
